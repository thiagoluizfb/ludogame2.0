...
function whostarts(i){
    ...
    setTimeout(function(){
        ...
        if (i==3){
            ...
            $("#"+players[i]+"dice").on("click",function (){rollthedice(i)});
        },100);
    }
    },100);
}
...
function move(i){
    ...
    function myTimer(){
        ...
        $("#"+players[i]+"Token"+token[movetoken]).css({"left": redleft[newpos-k+l]+"px","position": "absolute"});
        $("#"+players[i]+"Token"+token[movetoken]).css({"top": redtop[newpos-k+l]+"px","position": "absolute"});
        l++;
        if (l==k){
